...
namespace ViveHandTracking.Sample
{
    ...
    class PinchLaser : Laser
    {
        ...
        {
            var hand = GestureProvider.LeftHand;
            if (hand == null || GestureProvider.RightHand != null) return 0;
        ...
        void PushCube()
        {
            ...
            if (distance > 1f) rigidbody.AddForce(0, 8 / Time.fixedDeltaTime, 0, ForceMode.Acceleration);
        }
    }
